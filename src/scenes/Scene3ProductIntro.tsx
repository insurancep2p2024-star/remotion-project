...
// 0-74:  Logo + name + slogan (intro)
// 75-149: Benefits slide in from right
  ...
  return (
    <AbsoluteFill style={{ background: "#0A2540", opacity: alpha }}>
      ...
      <div style={{
        position: "absolute",
        inset: 0,
        background: "radial-gradient(ellipse 70% 60% at 50% 50%, rgba(0,102,255,0.22), transparent)",
      }} />
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            alignItems: "center",
            justifyContent: "center",
            boxShadow: "0 8px 48px rgba(0,102,255,0.55)",
            marginBottom: 40,
          ...
          {benefits.map((b, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{ fontSize: 52, lineHeight: 1, flexShrink: 0 }}>{b.icon}</div>
                <div style={{
                  fontSize: 46,
                  fontWeight: 700,
                  color: b.color,
